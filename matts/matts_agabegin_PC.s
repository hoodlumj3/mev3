...
AGA_Startup:
	...
	lea	GraphicsName-PC(a5),a1		; graphics name
	moveq	#0,d0			; any version
	jsr	_LVOOpenLibrary(a6)
	tst.l	d0
	beq	AGA_End			; failed to open? Then quit
	move.l	d0,GraphicsBase-PC(a5)
	move.l	d0,a6
	move.l	gb_ActiView(a6),wbview-PC(a5)
...
AGA_CloseDown:
	...
	move.l	wbview-PC(a5),a1
	move.l	GraphicsBase-PC(a5),a6
